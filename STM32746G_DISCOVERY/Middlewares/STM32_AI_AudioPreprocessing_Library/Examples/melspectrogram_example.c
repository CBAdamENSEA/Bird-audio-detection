 ...
 */
/*
#define SAMPLE_RATE  22500U // Input signal sampling rate
#define FFT_LEN       2046U // Number of FFT points. Must be greater or equal to FRAME_LEN
#define FRAME_LEN   1764U // Window length and then padded with zeros to match FFT_LEN
#define HOP_LEN        880U // Number of overlapping samples between successive frames
